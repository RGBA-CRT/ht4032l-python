...
cmd_start = b""
cmd_poll  = b""
cmd_get   = b""
...
class LA(object):
	...
	def __init__(self, driver="auto", index=0, dump=False):
		...
		self.status = array(uint32_typecode, b"\x00"*1024)
		#self.status.frombytes("\x00"*1024)
		#, "\x00"*1024)
	...
	def Reset(self):
		...
		res = self.driver.vendor_out(0xB3, 0, 0, b"\x0F\x03\x03\x03\x00\x00\x00\x00\x00\x00")
		sleep(0.005)
		return res!=0
